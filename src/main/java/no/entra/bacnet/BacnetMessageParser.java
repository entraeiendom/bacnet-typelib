...
public class BacnetMessageParser {
    ...
    public static BacnetResponse parse(String fullBacnetHexString) {
        ...
        if (apduResult.isParsedOk()) {
            ...
            ParserResult<Service> serviceParserResult = ServiceParser.parse(serviceChoice, unparsedHexString);
            if (serviceParserResult.isParsedOk()) {
                bacnetResponse = new BacnetResponse() {
                    ...
                    public Service getService() {
                        return serviceParserResult.getParsedObject();
                    }
                };
            }
